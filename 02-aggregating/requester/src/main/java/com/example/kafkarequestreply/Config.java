...
public class Config {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<Integer, Collection<ConsumerRecord<Integer, String>>>
                        kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<Integer, Collection<ConsumerRecord<Integer, String>>> factory =
